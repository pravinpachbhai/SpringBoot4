...
public class CustomerController {
    ...
    @Operation(
            ...
            description = "Fetches a paginated list of customers with optional sorting and paging parameters"
    )
    @ApiResponse(
            responseCode = "200",
    ...
    @ApiResponse(responseCode = "201", description = "Customer successfully created", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = CustomerDto.class))
    )
